...
namespace Learun.Util
{
    ...
    public class Time
    {
        ...
        public static string GetNextDayTime(string inputStr)
        {
            string nextDay = "";
            int monthDya = 0; //月里的天数
            if (!string.IsNullOrEmpty(inputStr))
            {
               DateTime dateCurrent =  Time.ToDate(inputStr);
                int year = dateCurrent.Year;
                int month = dateCurrent.Month;
                int day = dateCurrent.Day;
                if (Time.IsRuYear(year))
                {
                    //润年
                    switch (month)
                    {
                        case 1: case 3: case 5: case 7: case 8: case 10: case 12: monthDya = 31; break;
                        case 4: case 6: case 9: case 11: monthDya = 30; break;
                        case 2: monthDya = 29; break;
                    }
                }
                else
                {   //平年
                ...
                else
                {
                    if (day > 9)
                    {
                        nextDay = year + "-0" + month + "-" + day;
                    }
                    else
                    {
                        nextDay = year + "-0" + month + "-0" + day;
                    }
                }
            }
            return nextDay;
