...
namespace Learun.Application.Web
{
    ...
    public abstract class MvcControllerBase : Controller
    {
        ...
        /// <returns></returns>
        protected virtual ActionResult Success(string info, string title, OperationType type, string keyValue, string content,int CategoryId)
        {
        ...
        /// <param name="info"></param>
        /// <returns></returns>
        protected virtual ActionResult Fail(string info, string title, OperationType type, string keyValue, string content)
        {
            OperateLogModel operateLogModel = new OperateLogModel();
