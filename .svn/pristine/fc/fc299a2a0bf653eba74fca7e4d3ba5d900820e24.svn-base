(function () {
    ...
    var page = {
        ...
        init: function ($page) {
			...
			if(userinfo.baseinfo.gender==0)
			{
                $page.find('img').attr('src',"../pulsApp/images/on-girl.jpg");
			}
            ...
            learun.clientdata.get('department', {
                ...
                callback: function (data) {
                    $page.find('.subname').text(data.name || '华羿微电子');
                }
            });
            ...
            if (userinfo.baseinfo.userId != newUserinfo.baseinfo.userId) {
               ...
               // $page.find('img').attr('src', config.webapi + 'learun/adms/user/img?data=' + userinfo.baseinfo.userId);
                if (userinfo.baseinfo.gender == 0) {
                    ...
                    $page.find('img').attr('src', "../pulsApp/images/on-boy.jpg");
                }
