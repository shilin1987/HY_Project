...
namespace Learun.Plugin.HYIocInjection
{
    public partial class HttpHelper
    {
        ...
        /// <returns></returns>
        public string GetSOAPReSource(string url, string datastr)
        {
            try
            {
                //request
        ...
        public string GetURLReSource(string url, string datastr)
        {
            string result = "";
            try
            {
                ...
                s.CopyTo(ms);
                byte[] bt = ms.ToArray();
                result = System.Text.Encoding.UTF8.GetString(bt);
                return result;
