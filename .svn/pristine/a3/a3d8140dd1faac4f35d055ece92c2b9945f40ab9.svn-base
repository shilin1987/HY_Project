...
namespace Learun.Application.Excel
{
    ...
    public interface ExcelImportIBLL
    {
        ...
        /// 
        /// </summary>
        /// <param name="id">字段表里面importid</param>
        /// <param name="filedArray">需要导出子字段中文名</param>
        /// <returns></returns>
        IEnumerable<ExcelImportFieldEntity> GetModelFieldList(string id, string[] filedArray);
        /// <summary>
        /// 
        /// </summary>
        /// <param name="templateId">导入模板主键</param>
        ...
        /// <param name="filedArray">筛除选项</param>
        /// <returns></returns>
        string ImportUserTable(string templateId, string fileId, DataTable dt, string[] filedArray);
        #endregion
    }
}
