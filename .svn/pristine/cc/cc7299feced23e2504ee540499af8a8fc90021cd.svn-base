...
namespace Learun.Application.Organization
{
    ...
    public interface DepartmentIBLL
    {
        ...
        /// <returns></returns>
        List<DepartmentEntity> GetList(string companyId, int isRefreshCache = 0);
        /// <summary>
        /// 获取部门列表信息(根据公司Id)
        /// </summary>
        /// <param name="companyId">公司Id</param>
        ...
        /// <returns></returns>
        List<DepartmentEntity> GetList(string companyId, string keyWord,int isRefresh);
        /// <summary>
        /// 获取部门数据实体
        /// </summary>
        ...
        /// <returns></returns>
        ReturnCommon SaveEntity(string keyValue, DepartmentEntity departmentEntity);
