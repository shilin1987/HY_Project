...
namespace IdentityAuthentication.Database
{
    ...
    public partial class Hy_Recruit_WrittenExamination
    {
        ...
        public Nullable<decimal> F_Score { get; set; }
        public string F_WrittenTestQuestionBankId { get; set; }
        public string F_CandidatesID { get; set; }
        public string F_IDCard { get; set; }
    
        public virtual Hy_Recruit_WrittenExamination Hy_Recruit_WrittenExamination1 { get; set; }
        public virtual Hy_Recruit_WrittenExamination Hy_Recruit_WrittenExamination2 { get; set; }
    }
}
