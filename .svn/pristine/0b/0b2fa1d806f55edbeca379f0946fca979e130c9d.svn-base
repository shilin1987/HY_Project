...
namespace Learun.Application.TwoDevelopment.Platform
{
    ...
    /// 描 述：员工手册后台管理
    /// </summary>
    public class Hy_Recruit_TheEmployeeHandbookService : RepositoryFactory
    {
        #region 获取数据
        ...
        public IEnumerable<Hy_Recruit_TheEmployeeHandbookEntity> GetPageList(Pagination pagination, string queryJson)
        {
            try
            {
                ...
                t.F_ModifyDate
                ");
                strSql.Append("  FROM Hy_Recruit_TheEmployeeHandbook t ");
                ...
                return this.BaseRepository().FindList<Hy_Recruit_TheEmployeeHandbookEntity>(strSql.ToString(),dp, pagination);
            }
            catch (Exception ex)
            {
        ...
        public Hy_Recruit_TheEmployeeHandbookEntity GetHy_Recruit_TheEmployeeHandbookEntity(string keyValue)
        {
            try
            {
                return this.BaseRepository().FindEntity<Hy_Recruit_TheEmployeeHandbookEntity>(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void DeleteEntity(string keyValue)
        {
            try
            {
                this.BaseRepository().Delete<Hy_Recruit_TheEmployeeHandbookEntity>(t=>t.F_Id == keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
