...
namespace Learun.Application.Web.Areas.LR_OrganizationModule.Controllers
{
    ...
    public class CompanyController : MvcControllerBase
    {
        ...
        public ActionResult SaveForm(string keyValue, CompanyEntity entity)
        {
            ...
            return Success("保存成功！", "公司信息", string.IsNullOrEmpty(keyValue) ? OperationType.Create : OperationType.Update, entity.F_CompanyId, entity.ToJson(),3);
        }
        /// <summary>
        /// 删除表单数据
        /// </summary>
        ...
        public ActionResult DeleteForm(string keyValue)
        {
            ...
            return Success("删除成功！", "公司信息", OperationType.Delete, keyValue, "",3);
        }
        #endregion
    }
}