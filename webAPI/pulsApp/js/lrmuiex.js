/*
 * 版 本 Learun-ADMS V7.0.0 华羿敏捷开发框架(http://www.learun.cn)
 * Copyright (c) 2013-2017 上海华羿信息技术有限公司
 * 创建人：华羿-前端开发组
 * 日 期：2018.7.12
 * 描 述：华羿移动端框架(ADMS) 华羿移动框架方法扩展
 */
(function ($, learun) {
    "use strict";
    ...
    clientAsyncData.company = {
        ...
        init: function () {
            if (clientAsyncData.company.states === loadSate.no) {
                ...
                var ver = data.ver || "";
                learun.httpget(config.webapi + "User/CompanyMap", { ver: ver }, function (data) {
                    if (data) {
                        if (data.ver) {
    ...
    clientAsyncData.department = {
        ...
        init: function () {
            if (clientAsyncData.department.states === loadSate.no) {
                ...
                var ver = data.ver || "";
                learun.httpget(config.webapi + "User/Map", { ver: ver }, function (data) {
                    if (data) {
                        if (data.ver) {
    ...
    clientAsyncData.user = {
        ...
        init: function () {
            if (clientAsyncData.user.states === loadSate.no) {
                ...
                learun.httpget(config.webapi + "/user/usermap", { ver: ver }, function (data) {
                    if (data) {
                        if (data.ver) {
        ...
        init: function (modules) {
            if (learun.myModule.states === loadSate.no) {
                ...
                learun.httpget(config.webapi + "learun/adms/function/mylist", null, function (data) {
                    if (data) {
                        if (data.length == 0 && mymoduleData === null) {
                            var len = 7;
                            ...
                            learun.httppost(config.webapi + "learun/adms/function/mylist/update", String(list), function (res) { });
                        }
                        else{
