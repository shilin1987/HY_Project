(function () {
    ...
    var page = {
        ...
        sign: function (info, auditers) {// info加签信息
            ...
            learun.httppost(config.webapi + "learun/adms/workflow/audit", flowreq, function(data) {
    ...
    function taskinfo(_param) {
        ...
        learun.httpget(config.webapi + "learun/adms/workflow/taskinfo", req, function(data){
            learun.layer.loading(false);
            if (data) {
                var flowdata = data;
