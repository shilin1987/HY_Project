    ...
    var page = {
        ...
        init: function ($page, param) {
                            ...
                            event: function () {// 删除当前条信息
                                learun.layer.confirm('确定要删除该笔数据吗？', function (_index) {
                                    if (_index === '1') {
                                        ...
                                        learun.httppost(config.webapi + "learun/adms/crm/order/delete", keyValue, function (data) {
                                            if (data) {// 删除数据成功
                                                learun.nav.closeCurrent();
            ...
            $header.find('.lr-form-header-submit').on('tap', function () {
                ...
                learun.httppost(config.webapi + "learun/adms/crm/order/save", _postData, function (data) {
                    learun.layer.loading(false);
                    if (data) {// 表单数据保存成功
                        if (keyValue) {
            ...
            if (keyValue) {
                ...
                learun.httpget(config.webapi + "learun/adms/crm/order/form", keyValue, function (data) {
                    if (data) {
