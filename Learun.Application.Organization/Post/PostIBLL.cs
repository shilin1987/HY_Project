...
namespace Learun.Application.Organization
{
    ...
    public interface PostIBLL
    {
        ...
        /// <returns></returns>
        List<PostEntity> GetList(string companyId,int isRefresh);
        /// <summary>
        /// 获取岗位数据列表（根据公司列表）
        /// </summary>
        /// <param name="companyId">公司主键</param>
        ...
        /// <returns></returns>
        List<PostEntity> GetList(string companyId, string keyword, string departmentId, int isRefresh);
        /// <summary>
        /// 获取岗位数据列表(根据主键串)
        /// </summary>
        ...
        /// <param name="postIds">根据主键串</param>
        /// <returns></returns>
        ReturnCommon<List<APPDropDownListModel>> GetPostList();
        /// <summary>
        /// 获取树形结构数据
        /// </summary>
        /// <param name="companyId">公司主键</param>
