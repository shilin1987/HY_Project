...
namespace Learun.Application.Organization
{
    ...
    public interface UserIBLL
    {
        ...
        /// <param name="pagination">分页参数</param>
        /// <param name="keyword">查询关键词</param>
        /// /// <param name="queryJson">查询关键词</param>
        /// <returns></returns>
        List<UserEntity> GetPageList(string companyId, string departmentId, Pagination pagination, string keyword, string queryJson);
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <returns></returns>
        List<UserEntityDTO> GetModelPageList(string companyId, string departmentId, Pagination pagination, string keyword, string queryJson);
        ...
        /// <returns></returns>
        DataTable ConverDataTable(List<UserEntity> dataList);
        ...
        /// </summary>
        /// <returns></returns>
        IEnumerable<DataSourDTO> GetFiledList();
        #endregion
        ...
        /// <returns></returns>
        ReturnCommon SaveEntity(UserEntity userEntity);
        /// <summary>
        /// 保存用户表单（新增、修改）
        /// </summary>
        /// <param name="keyValue">主键值</param>
        ...
        /// <param name="password">密码 MD5 32位 小写</param>
        /// <returns></returns>
        ReturnCommon<UserEntity> CheckPhoneLogin(string phone, string vCode);
        /// <summary>
        /// 获取用户头像
        /// </summary>
