...
namespace Learun.Application.Web.Controllers
{
    ...
    public class UtilityController : MvcControllerBase
    {
        ...
        public void ExportExcel(string fileName, string columnJson, string dataJson, string exportField, string modeleId)
        {
            ...
            if (fileName == "用户导出")
            {
                //ExcelExportIBLL excelExpor = new ExcelExportBLL();
                //rowData = excelExpor.GetGeneralExport(modeleId, columnList, exportField);
                var exportFieldArray = exportField.Split(',');
                rowData = userService.GetExportList();
                rowData = rowData.DefaultView.ToTable(false, exportFieldArray);
            } 
            else 
