                ...
                if (data) {
                    ...
                    $('#release').on('click', function () {
                        ...
                        learun.layerForm({
                            id: 'CreateForm',
                            title: '创建流程',
                            url: top.$.rootUrl + '/LR_NewWorkFlow/NWFProcess/CreateForm?shcemeCode=' + shcemeCode,
                            width: 400,
                            height: 340,
                ...
                if (data) {
                    ...
                    $('#release').on('click', function () {
                        ...
                        learun.layerForm({
                            id: 'CreateForm',
                            title: '创建流程',
                            url: top.$.rootUrl + '/LR_NewWorkFlow/NWFProcess/CreateForm?processId=' + nwflow.processId,
                            width: 400,
                            height: 340,
                            callBack: function (id) {
                                return top[id].acceptClick(function (formData, auditers) {
