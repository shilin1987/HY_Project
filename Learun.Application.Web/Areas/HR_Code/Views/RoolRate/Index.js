    ...
    var page = {
        ...
        bind: function () {
            ...
            $('#lr_add').on('click', function () {
                learun.layerForm({
                    id: 'form',
                    title: '新增',
                    url: top.$.rootUrl + '/HR_Code/RoolRate/Form',
                    width: 600,
                    height: 400,
            ...
            $('#lr_edit').on('click', function () {
                ...
                if (learun.checkrow(keyValue)) {
                    learun.layerForm({
                        id: 'form',
                        title: '编辑',
                        url: top.$.rootUrl + '/HR_Code/RoolRate/Form?keyValue=' + keyValue,
                        width: 600,
                        height: 400,
                        callBack: function (id) {
                            return top[id].acceptClick(refreshGirdData);
            ...
            $('#lr_delete').on('click', function () {
                ...
                if (learun.checkrow(keyValue)) {
                    learun.layerConfirm('是否确认删除该项！', function (res) {
                        if (res) {
                            learun.deleteForm(top.$.rootUrl + '/HR_Code/RoolRate/DeleteForm', { keyValue: keyValue}, function () {
                                refreshGirdData();
                            });
                        }
                    });
        ...
        initGird: function () {
            $('#gridtable').lrAuthorizeJfGrid({
                url: top.$.rootUrl + '/HR_Code/RoolRate/GetPageList',
                headData: [
                    ...
                    { label: "结算日期", name: "F_RoomRateYreaMonth", width: 200, align: "center"},
                    { label: "结算房费", name: "F_Cost", width: 100, align: "center"},
                ],
                mainId:'F_ID',
                isPage: true
            });
