...
namespace Learun.Application.Web.Areas.LR_OrganizationModule.Controllers
{
    ...
    public class PostController : MvcControllerBase
    {
        ...
        [HttpGet]
        [AjaxOnly]
        public ActionResult GetList(string companyId, string keyword,string departmentId,int isRefresh=0)
        {
            var data = postIBLL.GetList(companyId, keyword, departmentId,isRefresh);
            return Success(data);
        }
        /// <summary>
        /// 获取树形数据
