...
namespace ProductLifecycle.Component.Tools.Ftp
{
    public class FTPUpFile
    { 

            string Filetype = "";
            string ipaddress = @"10.100.200.42:8012/Content/images/EmployeeAvatar";
            string Username = "MES_ADMIN";
            string Password = "mesadmin";
            /// <summary>
            /// FTP上传文件
            /// </summary>
        ...
        public bool UpFileService(HttpPostedFile file, string cardId, string docEndName, out string msg)
        {
            bool flag = true;
            try
            {
                string fileHeadImg = Config.GetValue("fileAppImgUrl");
                string fullFileName = string.Format("{0}/{1}{2}", fileHeadImg, cardId, docEndName);
