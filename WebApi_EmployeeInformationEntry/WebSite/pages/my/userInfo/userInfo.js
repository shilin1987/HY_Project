(function () {
    var page = {
        ...
        init: function ($page) {
			...
			$page.find('.department').text(baseinfo.department);
			$page.find('.minDepartment').text(baseinfo.minDepartment);
			$page.find('.userState').text(baseinfo.userState);
			$page.find('.OnJobStatus').text(baseinfo.onJobStatus);
			$page.find('.OneCardNumber').text(baseinfo.oneCardNumber);
